# ---------------------------------------------------------------------------
# Physics-based weather degradation — scattering model.
#
# Derived from LISA (Lidar Light Scattering Augmentation), Kilic et al.
#   https://github.com/velatkilic/LISA
#   V. Kilic, D. Hegde, V. Sindagi, A. B. Cooper, M. A. Foster, V. M. Patel,
#   "Lidar Light Scattering Augmentation (LISA): Physics-based Simulation of
#    Adverse Weather Conditions for 3D Object Detection", arXiv:2107.07004.
#
# This file has been MODIFIED from the original: `augment_mc` was rewritten as a
# vectorised PyTorch implementation with chunked GPU evaluation (`_process_chunk`),
# replacing the original per-point Monte-Carlo loop. The scattering physics —
# Mie coefficients, drop-size distributions, extinction and backscatter — is
# unchanged from the original work. The unmodified upstream implementation is
# retained alongside this file as `atmos_models_cpu.py`.
#
# LISA is licensed under the GNU General Public License v3.0; the full text is in
# LICENSE.md in this directory. Consequently this file, and the combined work that
# includes it, are distributed under GPL-3.0.
# ---------------------------------------------------------------------------
